...
| `test_messaging.py`, `test_messaging_edge.py`, `test_protocol.py`, `test_protocol_fuzz.py`, `test_zmq_edge.py` | ZMQ transports, wire protocol validation, fuzz-lite parser checks |
...
| `test_examples_run.py`, `test_question_examples_advanced.py`, `test_camera_feed.py` | Runs the example scripts (including the camera feed + overlay server) against a live in-process service |
